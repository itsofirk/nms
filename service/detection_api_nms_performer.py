...
from tensorflow.python.ops.image_ops_impl import non_max_suppression_with_scores as multiclass_non_max_suppression
...
class DetectionApiNmsPerformer(NmsPerformerBase):
    ...
    def nms_single_class(self, boxes, scores, input_metadata):
        ...
        nms_node = multiclass_non_max_suppression(
            ...
            # tensorflow
            boxes, scores, max_output_size, iou_thresh, score_thresh
        )
        # run nms evaluation
